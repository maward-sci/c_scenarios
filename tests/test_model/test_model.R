...
# Run functions:
df <- create_seagrass_exp(n_sim=1, methane=methane, nitrous_oxide = nitrous_oxide, biomass=biomass, soil=soil, treatments = c("Seed", "Transplant", "Infill"), restoration_status = c("Baseline", "Restoration"), n_years = 10)
